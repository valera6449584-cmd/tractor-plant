  ...
  return (
    ...
    >
      <div className="flex w-full items-center justify-between px-6">
        <Link href="/" className="pointer-events-auto transition-transform duration-300 hover:scale-105">
                ...
                <AnimatePresence>
                  {hovered === item.label && (
                    <motion.div
                      ...
                      className="pointer-events-none absolute -bottom-8 left-1/2 -translate-x-1/2 whitespace-nowrap rounded-md bg-black/70 px-3 py-1 text-xs text-white backdrop-blur"
                    >
                      {item.label}
                    </motion.div>
                  )}
